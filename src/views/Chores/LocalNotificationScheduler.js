...
const scheduleDueNotification = (
  ...
  if (
    devicePreferences['dueNotification'] !== true ||
    chorePreferences['dueDate'] !== true
  ) {
    return
  }
  const now = new Date()
...
const schedulePreDueNotification = (
  chore,
  userProfile,
  allPerformers,
  chorePreferences,
  ...
  if (
    devicePreferences['preDueNotification'] !== true ||
    chorePreferences['preDue'] !== true
  ) {
    return
  }
  const now = new Date()
...
const scheduleNaggingNotification = (
  chore,
  userProfile,
  allPerformers,
  chorePreferences,
  ...
  if (
    devicePreferences['naggingNotification'] === false ||
    chorePreferences.nagging !== true
  ) {
    return
  }
  const now = new Date()
