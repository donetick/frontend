  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Donetick is available in two deployment models with different terms
          and responsibilities:
        </p>
        <ul>
          <li>
            <strong>Cloud-Hosted Service:</strong> Hosted at donetick.com where
            we provide infrastructure and data management
          </li>
          <li>
            <strong>Self-Hosted Service:</strong> Open-source software you
            deploy on your own infrastructure
          </li>
        </ul>
        <p>
          Please review the applicable sections carefully as they define
      ...
      <p>
        <em>
          This section applies only to users of the Cloud Service at
          donetick.com
        </em>
      </p>
      ...
      <ul>
        <li>
          We strive to maintain 99.5% uptime for the Cloud Service on a monthly
          basis
        </li>
        <li>
        ...
        <li>
          We reserve the right to temporarily suspend service for emergency
          maintenance
        </li>
        <li>
          No SLA credits or compensation are provided for downtime unless
      ...
      <ul>
        <li>
          <strong>Your Data:</strong> You retain ownership of all Content you
          create or upload
        </li>
        <li>
          <strong>Our Responsibility:</strong> We provide secure hosting,
          backup, and infrastructure management
        </li>
        <li>
          <strong>Data Portability:</strong> You can export your data at any
          time through our export features
        </li>
        <li>
          <strong>Data Retention:</strong> We retain your data for 90 days after
          account deletion to allow recovery
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Subscription fees will automatically renew unless cancelled before the
          next billing cycle
        </li>
        <li>
        ...
        <li>
          Upon cancellation, you retain access until the end of your current
          billing period
        </li>
      ...
      <p>
        <em>
          This section applies to users deploying Donetick on their own
          infrastructure
        </em>
      </p>
      ...
      <ul>
        <li>
          <strong>Infrastructure:</strong> You are solely responsible for
          hosting, maintenance, security, and backups
        </li>
        <li>
          <strong>Data Protection:</strong> You are the data controller and
          responsible for compliance with applicable laws
        </li>
        <li>
          <strong>Updates:</strong> You are responsible for applying security
          updates and patches
        </li>
        <li>
          <strong>Support:</strong> No technical support is provided for
      ...
      <ul>
        <li>
          We provide no guarantees about the performance or security of
          self-hosted deployments
        </li>
        <li>
          We are not responsible for any data loss, security breaches, or
          service interruptions in self-hosted environments
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          You grant us the necessary rights to operate the service (Cloud
          Service only)
        </li>
        <li>
      ...
      <ul>
        <li>
          The Donetick name, logo, and proprietary features are our intellectual
          property
        </li>
      ...
      <ul>
        <li>
          Donetick integrates with third-party services (Telegram, Discord,
          webhooks, etc.)
        </li>
        <li>
      ...
      <ul>
        <li>
          Our total liability for the Cloud Service is limited to the amount you
        ...
        <li>
          We maintain appropriate insurance and implement security best
          practices
        </li>
      </ul>
      ...
      <p>
        ...
        expenses arising from your use of our services, violation of these
      ...
      <ul>
        ...
        <li>
          We will provide data export capabilities before termination when
          possible
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Email:</strong> legal@donetick.com
        </li>
        <li>
          <strong>Support:</strong> support@donetick.com
        </li>
        <li>
          <strong>Address:</strong> Favoro LLC, [Address to be provided]
        </li>
      </ul>
      ...
      <p style={{ fontSize: '14px', color: '#666' }}>
        ...
        <br />
        These Terms of Service are effective immediately for new users and will
        become effective for existing users 30 days after posting.
      </p>
    </div>
  )
}
